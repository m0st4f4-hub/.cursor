...
|--------------|----------------------------------------------------------|
| requestId    | Unique workflow identifier. See [system.md](system.md)    |
| Agent Role   | Specialized functional unit. See [roles.md](roles.md)     |
| Framework    | External execution engine. See [system.md](system.md)     |
| Rules        | Markdown files defining standards. See [init.md](init.md) |
| MCP          | Model Context Protocol Task Manager. See [system.md](system.md) |
| Chat Trigger | Legacy/fallback activation. See [system.md](system.md)    |
...
| 1.1     | 2024-06-10 | DocsAgent   | Added glossary, changelog, expanded examples and diagram explanation |

## CHANGE LOG

- 2024-06-10: Added glossary table at the top.
- 2024-06-10: Added more real-world examples and cross-references.
- 2024-06-10: Expanded diagram explanation.
